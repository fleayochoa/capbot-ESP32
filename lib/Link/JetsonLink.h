...
public:
    ...
    using WheelVelCallback  = void (*)(float wheelLeft, float wheelRight, void* ctx);
    ...
    void onWheelVelCmd(WheelVelCallback cb, void* ctx) { cbWheelVel_ = cb; ctxWheelVel_ = ctx; }
...
private:
    ...
    WheelVelCallback cbWheelVel_ = nullptr; void* ctxWheelVel_ = nullptr;
